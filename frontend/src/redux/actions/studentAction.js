...
export const studentUpdatePassword = (passwordData) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post(
        "http://localhost:5000/api/student/updatePassword",
        passwordData
      );
...
export const chatHelper = (name) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post("http://localhost:5000/api/student/getStudentByName", name);
...
export const getStudentByRegNum = (registrationNumber) => {
  return async (dispatch) => {
    try {
      ...
      const { data } = await axios.post("http://localhost:5000/api/student/getStudentByRegNum", {
        registrationNumber,
      });
...
export const getOTPStudent = (email) => {
  return async (dispatch) => {
    try {
      await axios.post("http://localhost:5000/api/student/forgotPassword", email);
...
export const submitOTPStudent = (credentials) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post("http://localhost:5000/api/student/postOTP", credentials);
...
export const sendMessage = (room, messageObj) => {
  return async () => {
    try {
      const { data } = await axios.post(
        `http://localhost:5000/api/student/chat/${room}`,
        messageObj
      );
    } catch (err) {
...
export const getPrivateConversation = (roomId) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(`http://localhost:5000/api/student/chat/${roomId}`);
  ...
  return async (dispatch) => {
    try {
      const { data } = await axios.get(
        `http://localhost:5000/api/student/chat/previousChats/${senderName}`
      );
...
export const newerChats = (receiverName) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get(
        `http://localhost:5000/api/student/chat/newerChats/${receiverName}`
      );
...
export const getAllSubjects = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get("http://localhost:5000/api/student/getAllSubjects");
...
export const fetchAttendance = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get("http://localhost:5000/api/student/checkAttendance");
...
export const getMarks = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get("http://localhost:5000/api/student/getMarks");
