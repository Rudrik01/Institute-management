...
export const adminGetAllSubjects = () => {
  return async (dispatch) => {
    try {
      const { data } = await axios.get("http://localhost:5000/api/admin/getSubjects");
...
export const adminAddSubject = (subjectCredential) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post(
        "http://localhost:5000/api/admin/addSubject",
        subjectCredential
      );
...
export const adminGetAllFaculty = (department) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post("http://localhost:5000/api/admin/getFaculties", department);
...
export const adminGetAllStudent = (credentials) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post("http://localhost:5000/api/admin/getStudents", credentials);
...
export const adminGetAllSubject = (credentials) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.post("http://localhost:5000/api/admin/getSubjects", credentials);
